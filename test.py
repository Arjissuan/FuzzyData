...
ph["normal"] = fuzz.gaussmf(ph.universe, float(np.mean(peha_norm)), float(np.std(peha_norm)))
ph["Suspicious"] = fuzz.gaussmf(ph.universe, float(np.mean(peha_sussy)), float(np.std(peha_sussy)))
ph["Abnormal"] = fuzz.gaussmf(ph.universe, float(np.mean(peha_abnm)), float(np.std(peha_abnm)))
